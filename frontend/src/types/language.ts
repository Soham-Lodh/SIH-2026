...
const UI_COPY = {
  en: {
    ...
    'future.generating': 'Generating flood predictions...',
  ...
  hi: {
    ...
    'future.generating': 'बाढ़ के पूर्वानुमान उत्पन्न किए जा रहे हैं...',
  ...
  bn: {
    ...
    'future.generating': 'বন্যার পূর্বাভাস তৈরি করা হচ্ছে...',
